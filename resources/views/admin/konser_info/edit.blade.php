...
@section('title', 'Info Konser Brilliant 2026')

@section('content_header')
    <h1 class="m-0"><i class="fas fa-music mr-2"></i>Pengaturan Konser Brilliant 2026</h1>
@stop
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        {{-- Card: Pengaturan Kategori Tiket --}}
        <div class="card card-outline card-warning">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-ticket-alt mr-2"></i>Pengaturan Info Tiket</h3>
            </div>
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="deskripsi_umum" class="font-weight-bold">Deskripsi <small class="text-muted">(tiap baris = 1 poin)</small></label>
                    <textarea class="form-control" id="deskripsi_umum" name="deskripsi_umum" rows="2">{{ old('deskripsi_umum', $pengaturan->deskripsi_umum) }}</textarea>
                </div>
                ...
                <div class="form-group">
                    <label for="deskripsi_vip" class="font-weight-bold">Deskripsi <small class="text-muted">(tiap baris = 1 poin)</small></label>
                    <textarea class="form-control" id="deskripsi_vip" name="deskripsi_vip" rows="2">{{ old('deskripsi_vip', $pengaturan->deskripsi_vip) }}</textarea>
                </div>
                ...
                <div class="form-group">
                    <label for="deskripsi_member" class="font-weight-bold">Deskripsi <small class="text-muted">(tiap baris = 1 poin)</small></label>
                    <textarea class="form-control" id="deskripsi_member" name="deskripsi_member" rows="2">{{ old('deskripsi_member', $pengaturan->deskripsi_member) }}</textarea>
                </div>
                ...
                <div class="form-group">
                    <label for="deskripsi_spesial" class="font-weight-bold">Deskripsi <small class="text-muted">(tiap baris = 1 poin)</small></label>
                    <textarea class="form-control" id="deskripsi_spesial" name="deskripsi_spesial" rows="2">{{ old('deskripsi_spesial', $pengaturan->deskripsi_spesial) }}</textarea>
                </div>
