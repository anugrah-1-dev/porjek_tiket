                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            @if($pendaftaran->bukti_pembayaran)
                                <a href="{{ route('admin.pendaftaran.offline.bukti', $pendaftaran->id) }}" target="_blank">
                                    <img src="{{ route('admin.pendaftaran.offline.bukti', $pendaftaran->id) }}" alt="Bukti Pembayaran" class="img-fluid rounded border">
                                </a>
                            @else
